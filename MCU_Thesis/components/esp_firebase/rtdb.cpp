...
static SemaphoreHandle_t firebase_lock = NULL;
...
{  // firebase_lock = xSemaphoreCreateMutex();
}
Json::Value RTDB::getData(const char* path) {
                    // xSemaphoreTake(firebase_lock, portMAX_DELAY);
